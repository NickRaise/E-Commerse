...
async function getProductData() {
    ...
    if(docSnap.exists()) {
        let productOb = docSnap.data();
        const productData = getProduct(productOb);
        
        const section = document.querySelector(".section");
        section.innerHTML = productData;
    }
    else console.log('Error ---- no document');
}
...
function getProduct(product) {
    ...
    <div class="product-detail w-3/6 flex flex-col gap-5">
